...
const steps = [
  { key: 'step1', icon: Search, bg: 'bg-pw-50', number: '01' },
  { key: 'step2', icon: Wrench, bg: 'bg-sky-50', number: '02' },
  { key: 'step3', icon: HeartHandshake, bg: 'bg-warm-50', number: '03' },
];
    ...
    <section id="process" className="py-20 sm:py-28 px-5 sm:px-8">
      <div className="mx-auto max-w-7xl">
          ...
          {steps.map((step, i) => {
            ...
            return (
              <AnimatedSection key={step.key} delay={i * 0.15}>
                <div className={`bento-block ${step.bg} p-8 sm:p-10 min-h-[320px] flex flex-col justify-between group hover:scale-[1.01] transition-transform duration-300`}>
                  <div className="flex items-center justify-between">
                    <span className="text-5xl sm:text-6xl font-extrabold text-gray-900/10">
                      {step.number}
                    </span>
        ...
        <AnimatedSection delay={0.3}>
          <div className="mt-4 sm:mt-5 bento-block bg-gray-900 p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
