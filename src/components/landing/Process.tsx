...
const steps = [
  { key: 'step1', icon: Search,        bg: 'bg-pw-50',   number: '01', title: 'Découverte & cadrage', text: 'On écoute vos objectifs, vos contraintes et votre cible. On définit ensemble le périmètre exact du projet.' },
  { key: 'step2', icon: Wrench,         bg: 'bg-sky-50',  number: '02', title: 'Design & développement', text: 'Maquettes validées par vous avant le code. Développement agile avec points hebdomadaires.' },
  { key: 'step3', icon: HeartHandshake, bg: 'bg-warm-50', number: '03', title: 'Livraison & suivi', text: 'Mise en ligne soignée + formation. Support inclus 3 mois. On reste partenaires sur la durée.' },
];
          ...
          <div className="mt-4 sm:mt-5 rounded-bento bg-gray-900 p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
            <div className="flex items-start gap-4">
              ...
              <p className="text-base sm:text-lg text-gray-300 leading-relaxed max-w-xl">
                Vous n'êtes jamais seul·e. Un interlocuteur dédié vous accompagne de A à Z, toujours disponible.
              </p>
            </div>
            <button
