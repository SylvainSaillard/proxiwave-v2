        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-5">
            ...
            <div className="rounded-bento relative h-full min-h-[340px] group cursor-pointer overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-7 sm:p-8">
                ...
                <div className="flex items-baseline gap-2 mt-2">
                  ...
                  <span className="text-lg font-semibold text-white/60">de trafic</span>
                </div>
                <p className="mt-3 text-sm text-white/80 leading-relaxed">
                  Refonte complète du site + SEO · Résultats en 3 mois
                </p>
              </div>
            </div>
          </AnimatedSection>
            ...
            <div className="rounded-bento bg-pw-50 p-7 sm:p-8 min-h-[200px] flex flex-col justify-between group hover:scale-[1.005] transition-transform duration-300">
              ...
              <div className="mt-4">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl sm:text-5xl font-extrabold text-pw-600">3x</span>
                  <span className="text-base font-semibold text-gray-400">plus rapide</span>
                </div>
                <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                  Application de gestion des stocks. Réduction des erreurs de 60%.
                </p>
              </div>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection className="md:col-span-3" delay={0.2}>
            <div className="rounded-bento bg-sky-50 p-7 sm:p-8 min-h-[200px] flex flex-col justify-between group hover:scale-[1.005] transition-transform duration-300">
              ...
              <div className="mt-4">
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl sm:text-5xl font-extrabold text-pw-500">+40%</span>
                  <span className="text-base font-semibold text-gray-400">de leads</span>
                </div>
                <p className="mt-3 text-sm text-gray-600 leading-relaxed">
                  Landing page + CRM intégré. ROI positif en moins de 2 mois.
                </p>
              </div>
            </div>
          </AnimatedSection>
        ...
        <div className="mt-4 sm:mt-5 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5">
          <AnimatedSection delay={0}>
            <div className="rounded-bento bg-gray-900 p-8 sm:p-10 text-center min-h-[160px] flex flex-col items-center justify-center">
              <span className="text-4xl sm:text-5xl font-extrabold text-white">50+</span>
              <span className="mt-2 text-sm font-medium text-gray-400">Projets livrés</span>
            </div>
          </AnimatedSection>
          <AnimatedSection delay={0.1}>
            <div className="rounded-bento bg-pw-500 p-8 sm:p-10 text-center min-h-[160px] flex flex-col items-center justify-center">
              <span className="text-4xl sm:text-5xl font-extrabold text-white">4.8/5</span>
              <span className="mt-2 text-sm font-medium text-pw-100">Satisfaction client</span>
            </div>
          </AnimatedSection>
          <AnimatedSection delay={0.2}>
            <div className="rounded-bento bg-sky-50 p-8 sm:p-10 text-center min-h-[160px] flex flex-col items-center justify-center">
              <span className="text-4xl sm:text-5xl font-extrabold text-pw-700">4 sem</span>
              <span className="mt-2 text-sm font-medium text-gray-500">Délai moyen</span>
            </div>
          </AnimatedSection>
        </div>
      </div>
